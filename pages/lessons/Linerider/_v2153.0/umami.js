!(function () {
  ...
  ((t) => {
    const {
      ...
      { hostname: s, pathname: u, search: l } = r,
      { currentScript: d } = c;
    if (!d) return;
    const m = "data-",
      ...
      j = (t, e) =>
        O(
          "string" == typeof t
            ? { ...A(), name: t, data: "object" == typeof e ? e : void 0 }
            : "object" == typeof t
              ? t
              : "function" == typeof t
                ? t(A())
      ...
      k = (t) => O({ ...A(), data: t }, "identify");
    t.umami || (t.umami = { track: j, identify: k });
    let x,
      E,
      I = `${u}${l}`,
      L = c.referrer,
    ...
    if (y && !$()) {
      (() => {
        ...
        (o.pushState = t(o, "pushState", U)),
          (o.replaceState = t(o, "replaceState", U));
      })(),
        (() => {
