...
var jackpotAI = {
  bot1: ["jGal | CSGOClicker.net", 1, "js/WTjn0MM.png"],
  bot2: ["exochase", 1, "js/za6Y17z.png"],
  bot3: ["S5E3", 1, "js/62001ac6b067182b65f92fa07797c630af64bb4a_full.jpg"],
  bot4: ["MR.BEATS", 2, "js/dIs0yE8.png"],
  bot5: ["CockCrusher19", 2, "js/03b0621515c85e256c20a8f169737430fa57281d_full.jpg"],
  bot6: ["Octane | n OU", 2, "js/P2hwwIE.png"],
  bot7: ["Moon Cricket Butler", 3, "js/wtf.jpg"],
  bot8: ["filsmick", 3, "js/c31d18ad931fd685ca3af5700db6a461e10bcfe8_full.jpg"],
  bot9: ["Nino Triste", 3, "js/n1iHk8a.png"],
  bot10: ["Lucky", 4, "js/Dg7cI81.png"],
  bot11: ["seif.", 4, "js/gcieULF.png"],
  bot12: ["Plebeian", 5, "js/ZjMTocK.png"],
  bot13: ["buckETS | Trading", 5, "js/wSVK1bt.png"],
  bot14: ["banned", 6, "js/575daf48a20828cb6470193b7067d2782aa5ff0f_full.jpg"],
  bot15: ["Roflzilla", 6, "js/prnsggZ.png"],
  bot16: ["Jainxu", 7, "js/nwEsAGH.png"],
  bot17: ["Platinum (diff7)", 7, "js/BzuCWzL.png"],
  bot18: ["sp00ky gh0stman", 8, "js/ISxQyow.png"],
  bot19: ["storM", 9, "js/e51667b64e8591b8428b4fc268fc826f21a982cf_full.jpg"]
};
...
function jackpotStart() {
  ...
  drawPlayerDepositor("DevDCorp Guest (you)", (playerTickets / 100).toFixed(2), "js/mascot.png");
  ...
  function winnerModalDraw() {
    ...
    var winningSkinsValue = 2*(totalTickets / 100).toFixed(2);
